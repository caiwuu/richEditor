...
class Range2 {
  ...
  constructor(config) {
    this.vm = config.vm
    this.startContainer = config.startContainer
    this.startOffset = config.startOffset
    this.endContainer = config.endContainer
  ...
  _updateStatus() {
    ...
    if (this.collapsed) {
      this._d = 0
    } else if (this.focusNode === this.endContainer && this.focusOffset === this.endOffset) {
      this._d = 2
    } else {
      this._d = 1
    }
  ...
  collapse(flag) {
    ...
    this.focusNode = this.endContainer
    this.focusOffset = this.endOffset
    this.collapsed = true
  }
  right(shiftKey) {
      ...
      if (shiftKey) {
        switch (this._d) {
          ...
          case 2:
            ...
            this.setFocus(container, offset)
            this._updateStatus()
            break
          case 1:
